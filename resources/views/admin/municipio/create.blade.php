				 ...
				 <div class="row">
				 	<div class="col-md-12">
				 		<ol class="breadcrumb">
						  ...
						  <li><a href="/departamento-municipio/{{ $departamento->id }}">{{ $departamento->nombre }}</a></li>
						</ol>				 		
				 	</div>
				 	<div class="col-md-12 text-center"><h4>Nuevo municipio</h4></div>
				 </div>
				 <div class="row">
				 	<div class="col-md-12">
				 		<form method="POST" action="{{ route('municipios.store') }}" id="form_registro">
				 		{{ csrf_field() }}
