        ...
        <div class="row">
          <div class="col-md-12">
            <ol class="breadcrumb">
              ...
              <li class="active">{{ $departamento->nombre}}</li>
            </ol>           
          </div>
         </div>

        <div class="row">
            <div class="col-md-6"><h4>Municipios de {{ $departamento->nombre}}</h4></div>
            <div class="col-md-6"><a href="/municipio-registrar/{{ $departamento->id }}" class="btn btn-primary pull-right">Nuevo</a></div>
        </div>
        <input type="hidden" name="departamento" value="{{ $departamento->id }}" id="departamento">
        <div class="row">
            <div class="col-md-12">
